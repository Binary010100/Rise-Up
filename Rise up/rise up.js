...
var block1 =  Bodies.rectangle(600,0,20,20,{frictionAir: 1, label:'cros'});
var block2 =  Bodies.rectangle(600,0,20,20,{frictionAir: 0.45, label:'dos'});
var block3 =  Bodies.rectangle(600,0,20,20,{frictionAir:0.09, label:'dos'});
var block4 =  Bodies.rectangle(600,0,20,20,{frictionAir: 0.01, label:'dos'});
var block5 =  Bodies.rectangle(600,0,20,20,{frictionAir: 0.001, label:'dos'});
...
World.add(engine.world,[balloon, controller, block1, block2 , block3, block4, block5, mouseConstraint,ground]);
    ...
    e.pairs.forEach(pair => {
      ...
      alert('you loose');
          location.reload();
             ...
             // if (labelA == 'cros' && labelB == 'nos') {
    //  alert('level 2');
                    //window.location.href = 'file:///C:/Users/admin/Documents/MatterJS/Rise%20up/rise%20up_level2.html';
